    ...
    <div className="bg-black p-8 mt-10">
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <ul className="flex gap-4 sm:mt-[12%]">
          <li><Image src={tweet} alt="Twitter" aria-label="Follow us on Twitter" /></li>
          <li><Image src={fb} alt="Facebook" aria-label="Follow us on Facebook" /></li>
          <li><Image src={yt} alt="YouTube" aria-label="Follow us on YouTube" /></li>
          <li><Image src={insta} alt="Instagram" aria-label="Follow us on Instagram" /></li>
        </ul>
      </div>
      ...
      <div className="sm:flex sm:items-center justify-between">
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
          <div className="flex items-center mt-4">
            <Image src={location} alt="Pakistan" className="w-6 h-5" />
